...
To preserve module boundaries without centralizing every UI string into `App/Resources/Localizable.xcstrings`, the template uses a decentralized localization and Slang-style code generation architecture:
